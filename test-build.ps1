# SCRIPT DE TESTE DE BUILD - GestaoBilhares
# Testa build apos correcoes de compatibilidade

Write-Host "INICIANDO TESTE DE BUILD..." -ForegroundColor Green
...
# Build de teste
Write-Host "Executando build de teste..." -ForegroundColor Green
$startTime = Get-Date
