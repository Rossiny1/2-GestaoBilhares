...
data class RotaResumo(
    ...
    fun getCicloFormatado(): String {
        val dataInicioFormatada = if (dataInicioCiclo != null) {
            com.example.gestaobilhares.core.utils.DateUtils.formatarDataBrasileira(java.util.Date(dataInicioCiclo))
        } else {
            "Data não definida"
        }
        
        val dataFimFormatada = if (dataFimCiclo != null) {
            com.example.gestaobilhares.core.utils.DateUtils.formatarDataBrasileira(java.util.Date(dataFimCiclo))
        } else {
            "Em andamento"
        }
