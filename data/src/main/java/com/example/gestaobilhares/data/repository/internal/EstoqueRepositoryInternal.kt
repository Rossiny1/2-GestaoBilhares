...
internal class EstoqueRepositoryInternal(
    ...
    suspend fun inserirHistoricoManutencaoMesa(
        ...
        return try {
            ...
            try {
                val fotoAntesUrlParaPayload = if (fotoAntesUrl != null && com.example.gestaobilhares.core.utils.FirebaseStorageManager.isFirebaseStorageUrl(fotoAntesUrl)) {
                    fotoAntesUrl
                } else {
                    ""
                }
                val fotoDepoisUrlParaPayload = if (fotoDepoisUrl != null && com.example.gestaobilhares.core.utils.FirebaseStorageManager.isFirebaseStorageUrl(fotoDepoisUrl)) {
                    fotoDepoisUrl
                } else {
                    ""
                }
