...
import com.example.gestaobilhares.ui.databinding.ItemContractManagementBinding
            ...
            when {
                status.startsWith("Ativo") -> {
                    if (status.contains("Assinado")) {
                        binding.chipStatus.setChipBackgroundColorResource(com.example.gestaobilhares.ui.R.color.green_100)
                        binding.chipStatus.setChipStrokeColorResource(com.example.gestaobilhares.ui.R.color.green_600)
                        binding.chipStatus.setTextColor(binding.root.context.getColor(com.example.gestaobilhares.ui.R.color.green_600))
                    } else {
                        binding.chipStatus.setChipBackgroundColorResource(com.example.gestaobilhares.ui.R.color.blue_100)
                        binding.chipStatus.setChipStrokeColorResource(com.example.gestaobilhares.ui.R.color.blue_600)
                        binding.chipStatus.setTextColor(binding.root.context.getColor(com.example.gestaobilhares.ui.R.color.blue_600))
                    }
                }
                status.startsWith("Inativo") -> {
                    binding.chipStatus.setChipBackgroundColorResource(com.example.gestaobilhares.ui.R.color.red_100)
                    binding.chipStatus.setChipStrokeColorResource(com.example.gestaobilhares.ui.R.color.red_600)
                    binding.chipStatus.setTextColor(binding.root.context.getColor(com.example.gestaobilhares.ui.R.color.red_600))
                }
                status == "Sem Contrato" -> {
                    binding.chipStatus.setChipBackgroundColorResource(com.example.gestaobilhares.ui.R.color.orange_100)
                    binding.chipStatus.setChipStrokeColorResource(com.example.gestaobilhares.ui.R.color.orange_600)
                    binding.chipStatus.setTextColor(binding.root.context.getColor(com.example.gestaobilhares.ui.R.color.orange_600))
                }
                else -> {
                    // Status padrão
                    binding.chipStatus.setChipBackgroundColorResource(com.example.gestaobilhares.ui.R.color.gray_100)
                    binding.chipStatus.setChipStrokeColorResource(com.example.gestaobilhares.ui.R.color.gray_600)
                    binding.chipStatus.setTextColor(binding.root.context.getColor(com.example.gestaobilhares.ui.R.color.gray_600))
                }
            }
