...
import com.example.gestaobilhares.ui.databinding.FragmentGlobalExpensesBinding
...
class GlobalExpensesFragment : Fragment() {
    ...
    private fun navigateToAddExpense() {
        ...
        findNavController().navigate(
            com.example.gestaobilhares.ui.R.id.action_globalExpensesFragment_to_expenseRegisterFragment
        )
    }
