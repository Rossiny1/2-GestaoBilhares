...
import com.example.gestaobilhares.ui.databinding.DialogApproveColaboradorBinding
...
class ColaboradorApprovalDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.root.findViewById<android.widget.TextView>(com.example.gestaobilhares.ui.R.id.tvTitle)?.text = title
