...
import com.example.gestaobilhares.ui.databinding.FragmentAditivoSignatureBinding
        ...
        lifecycleScope.launch {
            try {
                ...
                val metadata = metadataCollector?.collectSignatureMetadata(
                    documentHash,
                    signatureHash
                ) ?: com.example.gestaobilhares.core.utils.SignatureMetadata(
    ...
    private fun enviarAditivoViaWhatsApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                val pdfGenerator = com.example.gestaobilhares.core.utils.AditivoPdfGenerator(requireContext())
                ...
                val pdfFile = pdfGenerator.generateAditivoPdf(aditivo, contrato, mesas, representanteLegal)
