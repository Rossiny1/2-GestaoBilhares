...
object AppLogger {
    ...
    // ✅ FASE 12.4: Habilitar logs apenas em DEBUG
    // Nota: BuildConfig não disponível em módulos de biblioteca
    // Usar sempre true por enquanto (pode ser configurado via DataStore no futuro)
