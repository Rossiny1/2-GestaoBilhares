...
class AditivoPdfGenerator(private val context: Context) {
    ...
    fun generateAditivoPdf(
        ...
        val footerHandler = AditivoFooterHandler(timestampGeracao)
     ...
     */
    private class AditivoFooterHandler(
        ...
        override fun handleEvent(event: Event) {
            ...
            try {
                ...
                android.util.Log.e("AditivoPdfGenerator", "Erro ao adicionar rodapé: ${e.message}", e)
