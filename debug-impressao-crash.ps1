# ========================================
# DEBUG CRASH NA IMPRESSÃO
# ========================================

Write-Host "Debug Crash na Impressão - GestaoBilhares" -ForegroundColor Cyan
...
$logFile = "logcat-impressao-crash-$(Get-Date -Format 'yyyyMMdd-HHmmss').txt"
Start-Job -ScriptBlock {
    param($adb, $logFile)
    & $adb logcat -s "AndroidRuntime:E" "FATAL:*" "SettlementSummaryDialog:*" "BluetoothPrinterHelper:*" "System.err:*" "BluetoothAdapter:*" "BluetoothSocket:*" | Tee-Object -FilePath $logFile
...
Write-Host "7. Selecione uma impressora" -ForegroundColor White
Write-Host "8. Aguarde o crash acontecer" -ForegroundColor White
Write-Host ""
