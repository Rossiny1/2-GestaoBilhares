...
class PanosEstoqueAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PanoViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_pano_estoque, parent, false)
    ...
    inner class PanoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val tvNumeroPano: TextView = itemView.findViewById(R.id.tvNumeroPano)
        private val tvInfoPano: TextView = itemView.findViewById(R.id.tvInfoPano)
        private val tvStatusPano: TextView = itemView.findViewById(R.id.tvStatusPano)
