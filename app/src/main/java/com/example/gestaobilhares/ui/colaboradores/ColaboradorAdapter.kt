...
import com.example.gestaobilhares.databinding.ItemColaboradorBinding
        ...
        fun bind(colaborador: Colaborador) {
            binding.apply {
                ...
                val statusBackground = when {
                    !colaborador.aprovado -> com.example.gestaobilhares.R.drawable.rounded_tag_orange
                    colaborador.ativo -> com.example.gestaobilhares.R.drawable.rounded_tag_green
                    else -> com.example.gestaobilhares.R.drawable.rounded_tag_red
                }
