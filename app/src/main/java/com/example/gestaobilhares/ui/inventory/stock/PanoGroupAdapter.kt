...
class PanoGroupAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PanoGroupViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_pano_group, parent, false)
    ...
    inner class PanoGroupViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val tvPanoInfo: TextView = itemView.findViewById(R.id.tvPanoInfo)
        private val tvPanoNumeracao: TextView = itemView.findViewById(R.id.tvPanoNumeracao)
