# ========================================
# SCRIPT PARA TESTAR SOLUÇÃO COM SPINNER
# ========================================
#
# INSTRUÇÕES:
# 1. Conecte seu dispositivo Android com a depuração USB ativada.
# 2. Execute este script a partir do terminal PowerShell.
# 3. O script irá monitorar especificamente os logs do Spinner.
#
# ========================================

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "TESTE SOLUÇÃO COM SPINNER - METAS" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Dispositivo conectado. Testando solução com Spinner..." -ForegroundColor Green
Write-Host ""
...
Write-Host "4. Observe se o SPINNER de ciclos está funcionando" -ForegroundColor White
Write-Host "5. Tente selecionar um ciclo e criar uma meta" -ForegroundColor White
Write-Host ""
Write-Host "MONITORANDO LOGS DO SPINNER..." -ForegroundColor Green
Write-Host "Pressione Ctrl+C para parar" -ForegroundColor Gray
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# Padrão específico para debug do Spinner
$patternSpinner = "MetaCadastroFragment|Spinner configurado|Ciclo selecionado|Total de ciclos encontrados|Ciclos filtrados para metas|Spinner|onItemSelected|ArrayAdapter|simple_spinner|Ciclo.*Em Andamento|Ciclo.*Planejado|Nenhum ciclo disponível|Selecione um ciclo"

# Monitorar logs
try {
    & $adbPath logcat | Where-Object { $_ -match $patternSpinner } | ForEach-Object {
