...
object SyncManager {
    ...
    private const val SYNC_INTERVAL_HOURS = 6L // Sincronizar automaticamente a cada 6 horas (somente em condições ideais)
    ...
    fun schedulePeriodicSync(context: Context) {
        ...
        WorkManager.getInstance(context).enqueueUniquePeriodicWork(
            ...
            ExistingPeriodicWorkPolicy.UPDATE, // Atualizar caso parâmetros mudem
            syncWorkRequest
        )
    }
