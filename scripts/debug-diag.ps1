# ========================================
# SCRIPT DE MONITORAMENTO DEBUG_DIAG - GESTAO BILHARES
# ========================================
#
...
Write-Host "MONITORAMENTO DEBUG_DIAG - GESTAO BILHARES" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "4. Execute: .\debug-diag.ps1" -ForegroundColor Yellow
Write-Host ""
Write-Host "CAMINHO ADB: C:\Users\Rossiny\AppData\Local\Android\Sdk\platform-tools\adb.exe" -ForegroundColor Green
Write-Host ""
Write-Host "MONITORANDO LOGS DEBUG_DIAG DO APP..." -ForegroundColor Magenta
...
Write-Host "Iniciando monitoramento DEBUG_DIAG..." -ForegroundColor Green
...
try {
    ...
    Write-Host "Filtro: DEBUG_DIAG" -ForegroundColor Gray
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host ""
    & $adbPath logcat -s DEBUG_DIAG
} catch {
